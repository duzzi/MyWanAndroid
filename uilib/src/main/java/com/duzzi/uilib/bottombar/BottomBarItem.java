package com.duzzi.uilib.bottombar;
...
public class BottomBarItem extends LinearLayout {
    ...
    private boolean mHasIcon = true;// 是否显示图标，默认显示
    private boolean mHasText = true;// 是否显示文字，默认显示
    ...
    private void initAttrs(TypedArray ta) {
        ...
        mHasIcon = ta.getBoolean(R.styleable.BottomBarItem_hasIcon, mHasIcon);
        mHasText = ta.getBoolean(R.styleable.BottomBarItem_hasText, mHasText);
    ...
    private View initView() {
        ...
        mImageView.setVisibility(!mHasIcon ? GONE : VISIBLE);
        mTextView.setVisibility(!mHasText ? GONE : VISIBLE);
        return view;
    }
     ...
     * 设置未读数
     *
     * @param unreadNum 小于等于{@link com.duzzi.uilib.bottombar.BottomBarItem#unreadNumThreshold}则隐藏，
     *                  大于0小于{@link com.duzzi.uilib.bottombar.BottomBarItem#unreadNumThreshold}则显示对应数字，
     *                  超过{@link com.duzzi.uilib.bottombar.BottomBarItem#unreadNumThreshold}
     *                  显示{@link com.duzzi.uilib.bottombar.BottomBarItem#unreadNumThreshold}+
     */
